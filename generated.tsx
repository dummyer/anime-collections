 ...
 * });
 */
export function useGetOneAnimeQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetOneAnimeQuery,
    GetOneAnimeQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetOneAnimeQuery, GetOneAnimeQueryVariables>(
    GetOneAnimeDocument,
    options
  );
}
export function useGetOneAnimeLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetOneAnimeQuery, GetOneAnimeQueryVariables>(
    GetOneAnimeDocument,
    options
  );
}
export type GetOneAnimeQueryHookResult = ReturnType<typeof useGetOneAnimeQuery>;
export type GetOneAnimeLazyQueryHookResult = ReturnType<
  typeof useGetOneAnimeLazyQuery
>;
export type GetOneAnimeQueryResult = Apollo.QueryResult<
  GetOneAnimeQuery,
  GetOneAnimeQueryVariables
>;
 ...
 * });
 */
export function useMostFavAnimeQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MostFavAnimeQuery,
    MostFavAnimeQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MostFavAnimeQuery, MostFavAnimeQueryVariables>(
    MostFavAnimeDocument,
    options
  );
}
export function useMostFavAnimeLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MostFavAnimeQuery,
    MostFavAnimeQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MostFavAnimeQuery, MostFavAnimeQueryVariables>(
    MostFavAnimeDocument,
    options
  );
}
export type MostFavAnimeQueryHookResult = ReturnType<
  typeof useMostFavAnimeQuery
>;
export type MostFavAnimeLazyQueryHookResult = ReturnType<
  typeof useMostFavAnimeLazyQuery
>;
export type MostFavAnimeQueryResult = Apollo.QueryResult<
  MostFavAnimeQuery,
  MostFavAnimeQueryVariables
>;
